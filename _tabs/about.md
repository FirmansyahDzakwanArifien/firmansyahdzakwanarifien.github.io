...
Right now, I'm focused on growing as a well-rounded security professional. I'm particularly interested in deepening my penetration testing skills and exploring how DevSecOps can improve security throughout the development lifecycle. I want to stay involved in the community—whether that's mentoring others, contributing to cybersecurity initiatives, or participating in capture-the-flag competitions to keep my technical edge sharp.

My goal is to become a security professional who can bridge the gap between infrastructure, operations, and security strategy.

## Let's Connect

I'm always open to learning from others and sharing knowledge. Whether you want to discuss cybersecurity challenges, explore infrastructure solutions, collaborate on projects, or just chat about the tech world—feel free to reach out.
