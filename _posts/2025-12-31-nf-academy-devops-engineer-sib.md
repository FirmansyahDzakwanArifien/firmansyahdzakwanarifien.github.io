...
24/7 access to the **Learning Management System (LMS)** at [learning.nfacademy.id](https://learning.nfacademy.id) enables self-paced learning alongside structured sessions.
...
|:--------|:-----------|:----------------|
| **NF Academy DevOps** | Cloud & Automation | 95/100 (Sangat Baik) |
| **Cyber Sentinel** | Web Pentesting | Graduate (188/850+) |
| **SMTP 2025** | Cybersecurity | High Distinction |
| **Jarvis Academy** | System Admin | Grade A (All Levels) |
...
- **Verification**: [Certificate Verification Link](https://sinufia.nfacademy.id/certificate-verification/e475e2d9-6e73-4a38-93ca-b56041d0c00d)
...
- **Website**: [nfacademy.id](https://nfacademy.id)
- **LMS Platform**: [learning.nfacademy.id](https://learning.nfacademy.id)
...
**Verification URL:** [https://sinufia.nfacademy.id/certificate-verification/e475e2d9-6e73-4a38-93ca-b56041d0c00d](https://sinufia.nfacademy.id/certificate-verification/e475e2d9-6e73-4a38-93ca-b56041d0c00d)
